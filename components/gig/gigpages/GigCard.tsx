...
//             <span className="text-xs text-gray-400">Video Uploader</span>
//             <span className="text-xs text-gray-400">
//               {testfilteredvids.length}/4 videos
//             </span>
//           </div>

//           {/* Videos List */}
//           <div className="space-y-2 max-h-40 overflow-y-auto custom-scrollbar">
//             {testfilteredvids.map((video) => (
//               <div
//                 key={video._id}
//                 className="flex items-center justify-between bg-gray-800/50 rounded-lg p-2 group"
//               >
...
//                   onClick={(e) => {
//                     e.stopPropagation();
//                     // Add your delete video handler here
//                   }}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center text-sm text-gray-400 ">
            ...
            <span>{gig?.viewCount && gig?.viewCount.length} views</span>
            <span
              className="mr-3 text-[7px] flex items-center text-yellow-400 font-bold bg-gray-500  py-1 rounded-xl px-1 mx-3"
              onClick={() => mutate(`/api/videos/getvideos`)}
            >
              <RefreshCcw
                style={{ color: "white", fontWeight: 600, margin: 2 }}
                size={12}
              />
              Refresh
            </span>
