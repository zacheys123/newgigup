    ...
    <div className="relative mb-10">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-3 -left-6 w-4 h-4 rounded-full bg-purple-200 opacity-70"></div>
          <div className="absolute -bottom-2 -right-6 w-3 h-3 rounded-full bg-indigo-200 opacity-70"></div>
        </div>
      </div>
      <div className="mt-8 h-px w-full bg-gradient-to-r from-transparent via-gray-200 to-transparent"></div>
    </div>
  );
};
